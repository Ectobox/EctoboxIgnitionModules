...
| **Charts** | Twelve animated chart components — line, area, column, bar, scatter, bubble, pie, donut, gauge, sparkline, heatmap, and an SPC control chart — hand-drawn as crisp SVG (no charting library), with a curated palette and automatic light/dark theming. Plus `system.ectobox.charts.spc.*` for SPC analysis in Jython. | [Charts.md](Charts.md) | [v1.0.10](https://github.com/Ectobox/EctoboxIgnitionModules/releases/download/modules/Ectobox-Charts-8.3.modl) |
| **Diagrams** | Mermaid-style flowcharts and state diagrams written as plain text, laid out automatically, and rendered as crisp SVG — and live: bind node and edge state to tags so the diagram shows what the plant is doing right now. Plus `system.ectobox.diagrams.*` to generate diagrams from a query, a transition table, or your tag tree. | [Diagrams.md](Diagrams.md) | [v0.1.4](https://github.com/Ectobox/EctoboxIgnitionModules/releases/download/modules/Ectobox-Diagrams-8.3.modl) |
...
| **Schedule** | A modern equipment schedule / planner — a drag-first alternative to the built-in Equipment Schedule. Drag jobs between swim lanes (with per-lane accept rules), resize and multi-select, drop objects onto the timeline to create cards, and dress cards with badges, a progress bar, a colored icon block, and per-lane or plant-wide state bands. Curated palette, automatic light/dark, horizontal or vertical. | [Schedule.md](Schedule.md) | [v1.0.40](https://github.com/Ectobox/EctoboxIgnitionModules/releases/download/modules/Ectobox-Schedule-8.3.modl) |
